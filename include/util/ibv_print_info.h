...
// enum to string
const char* transport_type_str(enum ibv_transport_type type); // rdma_trans_type
const char* atomic_cap_str(enum ibv_atomic_cap cap); // capability for atomic support
const char* max_mtu_str(enum ibv_mtu mtu); // eg1500
